package net.mcreator.mcrshorts;
...
@Mod("mcrshorts")
public class McrshortsMod {
	public static final Logger LOGGER = LogManager.getLogger(McrshortsMod.class);
	public static final String MODID = "mcrshorts";

	public McrshortsMod(IEventBus modEventBus) {
