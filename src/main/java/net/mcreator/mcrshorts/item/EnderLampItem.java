...
import net.mcreator.mcrshorts.procedures.EnderLampWuPinZaiShouShangShiMeiKeFaShengProcedure;
import net.mcreator.mcrshorts.procedures.EnderLampTeShuXinXiProcedure;

import java.util.List;

public class EnderLampItem extends Item {
	public EnderLampItem(Item.Properties properties) {
	...
	public void inventoryTick(ItemStack itemstack, Level world, Entity entity, int slot, boolean selected) {
		...
		EnderLampWuPinZaiShouShangShiMeiKeFaShengProcedure.execute(world, entity.getX(), entity.getY(), entity.getZ(), entity, itemstack);
	}
}