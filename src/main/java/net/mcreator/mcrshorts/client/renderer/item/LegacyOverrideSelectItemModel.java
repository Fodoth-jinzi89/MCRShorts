package net.mcreator.mcrshorts.client.renderer.item;
...
public class LegacyOverrideSelectItemModel implements ItemModel {
	...
	public static void registerItemModelTypes(RegisterItemModelsEvent event) {
		event.register(ResourceLocation.parse("mcrshorts:legacy_overrides"), LegacyOverrideSelectItemModel.Unbaked.MAP_CODEC);
	}
}